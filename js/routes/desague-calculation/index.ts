...
/**
* @see \App\Http\Controllers\DesagueCalculationController::enableCollab
 * @see app/Http/Controllers/DesagueCalculationController.php:120
 * @route '/desague-calculation/{desagueCalculation}/enable-collab'
 */
export const enableCollab = (args: { desagueCalculation: number | { id: number } } | [desagueCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/desague-calculation/{desagueCalculation}/enable-collab'
 */
enableCollab.url = (args: { desagueCalculation: number | { id: number } } | [desagueCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { desagueCalculation: args }
    }
 ...
 * @route '/desague-calculation/{desagueCalculation}/enable-collab'
 */
enableCollab.post = (args: { desagueCalculation: number | { id: number } } | [desagueCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: enableCollab.url(args, options),
    method: 'post',
})
 ...
 * @route '/desague-calculation/{desagueCalculation}/enable-collab'
 */
    const enableCollabForm = (args: { desagueCalculation: number | { id: number } } | [desagueCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/desague-calculation/{desagueCalculation}/enable-collab'
 */
        enableCollabForm.post = (args: { desagueCalculation: number | { id: number } } | [desagueCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: enableCollab.url(args, options),
            method: 'post',
        })
    
    enableCollab.form = enableCollabForm
const desagueCalculation = {
...
export default desagueCalculation