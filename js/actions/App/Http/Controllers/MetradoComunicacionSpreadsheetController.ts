...
/**
* @see \App\Http\Controllers\MetradoComunicacionSpreadsheetController::updateMetrado
 ...
 */
export const updateMetrado = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/metrado'
 */
updateMetrado.url = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { metradosComunicacion: args }
    }
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/metrado'
 */
updateMetrado.patch = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateMetrado.url(args, options),
    method: 'patch',
})
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/metrado'
 */
    const updateMetradoForm = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/metrado'
 */
        updateMetradoForm.patch = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateMetrado.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
/**
* @see \App\Http\Controllers\MetradoComunicacionSpreadsheetController::updateResumen
 ...
 */
export const updateResumen = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/resumen'
 */
updateResumen.url = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { metradosComunicacion: args }
    }
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/resumen'
 */
updateResumen.patch = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateResumen.url(args, options),
    method: 'patch',
})
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/resumen'
 */
    const updateResumenForm = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/resumen'
 */
        updateResumenForm.patch = (args: { metradosComunicacion: number | { id: number } } | [metradosComunicacion: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateResumen.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PATCH',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
/**
* @see \App\Http\Controllers\MetradoComunicacionSpreadsheetController::enableCollaboration
 ...
 */
export const enableCollaboration = (args: { metradosComunicacion: string | number } | [metradosComunicacion: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/enable-collab'
 */
enableCollaboration.url = (args: { metradosComunicacion: string | number } | [metradosComunicacion: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { metradosComunicacion: args }
    }
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/enable-collab'
 */
enableCollaboration.post = (args: { metradosComunicacion: string | number } | [metradosComunicacion: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: enableCollaboration.url(args, options),
    method: 'post',
})
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/enable-collab'
 */
    const enableCollaborationForm = (args: { metradosComunicacion: string | number } | [metradosComunicacion: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/metrados/comunicaciones/{metradosComunicacion}/enable-collab'
 */
        enableCollaborationForm.post = (args: { metradosComunicacion: string | number } | [metradosComunicacion: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: enableCollaboration.url(args, options),
            method: 'post',
        })
    
    enableCollaboration.form = enableCollaborationForm
const MetradoComunicacionSpreadsheetController = { index, store, join, show, update, updateMetrado, updateResumen, destroy, enableCollaboration }

export default MetradoComunicacionSpreadsheetController