...
/**
* @see \App\Http\Controllers\CaidaTensionController::enableCollaboration
 * @see app/Http/Controllers/CaidaTensionController.php:142
 * @route '/caida-tension/{caidaTension}/enable-collab'
 */
export const enableCollaboration = (args: { caidaTension: number | { id: number } } | [caidaTension: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/caida-tension/{caidaTension}/enable-collab'
 */
enableCollaboration.url = (args: { caidaTension: number | { id: number } } | [caidaTension: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { caidaTension: args }
    }
 ...
 * @route '/caida-tension/{caidaTension}/enable-collab'
 */
enableCollaboration.post = (args: { caidaTension: number | { id: number } } | [caidaTension: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: enableCollaboration.url(args, options),
    method: 'post',
})
 ...
 * @route '/caida-tension/{caidaTension}/enable-collab'
 */
    const enableCollaborationForm = (args: { caidaTension: number | { id: number } } | [caidaTension: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/caida-tension/{caidaTension}/enable-collab'
 */
        enableCollaborationForm.post = (args: { caidaTension: number | { id: number } } | [caidaTension: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: enableCollaboration.url(args, options),
            method: 'post',
        })
    
    enableCollaboration.form = enableCollaborationForm
const CaidaTensionController = { index, store, join, show, update, destroy, enableCollaboration }

export default CaidaTensionController