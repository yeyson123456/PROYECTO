...
/**
* @see \App\Http\Controllers\AcCalculationController::enableCollaboration
 * @see app/Http/Controllers/AcCalculationController.php:137
 * @route '/ac-calculation/{acCalculation}/enable-collab'
 */
export const enableCollaboration = (args: { acCalculation: number | { id: number } } | [acCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/ac-calculation/{acCalculation}/enable-collab'
 */
enableCollaboration.url = (args: { acCalculation: number | { id: number } } | [acCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { acCalculation: args }
    }
 ...
 * @route '/ac-calculation/{acCalculation}/enable-collab'
 */
enableCollaboration.post = (args: { acCalculation: number | { id: number } } | [acCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: enableCollaboration.url(args, options),
    method: 'post',
})
 ...
 * @route '/ac-calculation/{acCalculation}/enable-collab'
 */
    const enableCollaborationForm = (args: { acCalculation: number | { id: number } } | [acCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/ac-calculation/{acCalculation}/enable-collab'
 */
        enableCollaborationForm.post = (args: { acCalculation: number | { id: number } } | [acCalculation: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: enableCollaboration.url(args, options),
            method: 'post',
        })
    
    enableCollaboration.form = enableCollaborationForm
const AcCalculationController = { index, store, join, show, update, destroy, enableCollaboration }

export default AcCalculationController