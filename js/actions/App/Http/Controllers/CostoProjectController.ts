...
/**
* @see \App\Http\Controllers\CostoProjectController::runMigration
 * @see app/Http/Controllers/CostoProjectController.php:431
 * @route '/costos/{costoProject}/migrate'
 */
export const runMigration = (args: { costoProject: number | { id: number } } | [costoProject: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: runMigration.url(args, options),
    method: 'post',
})
 ...
 * @route '/costos/{costoProject}/migrate'
 */
runMigration.url = (args: { costoProject: number | { id: number } } | [costoProject: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { costoProject: args }
    }
    ...
    return runMigration.definition.url
            .replace('{costoProject}', parsedArgs.costoProject.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/costos/{costoProject}/migrate'
 */
runMigration.post = (args: { costoProject: number | { id: number } } | [costoProject: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: runMigration.url(args, options),
    method: 'post',
})
 ...
 * @route '/costos/{costoProject}/migrate'
 */
    const runMigrationForm = (args: { costoProject: number | { id: number } } | [costoProject: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: runMigration.url(args, options),
        method: 'post',
    })
 ...
 * @route '/costos/{costoProject}/migrate'
 */
        runMigrationForm.post = (args: { costoProject: number | { id: number } } | [costoProject: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: runMigration.url(args, options),
            method: 'post',
        })
    
    runMigration.form = runMigrationForm
const CostoProjectController = { index, create, edit, store, show, destroy, runMigration }

export default CostoProjectController