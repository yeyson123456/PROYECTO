...
export interface AguaCalculationSpreadsheetSummary {
    id: number;
    name: string;
    project_name?: string;
...
interface PageProps {
    spreadsheets: AguaCalculationSpreadsheetSummary[];
...
export default function Index() {
    ...
    const handleCreate = (e: React.FormEvent) => {
        e.preventDefault();
        setProcessing(true);
        router.post(calcAguaRoutes.store.url(), { name, project_name: projectName }, {
    ...
    const handleJoin = (e: React.FormEvent) => {
        e.preventDefault();
        setProcessing(true);
        router.post(calcAguaRoutes.join.url(), { code: code.toUpperCase() }, {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="w-full rounded-lg bg-white px-12 py-6 shadow dark:bg-gray-900">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">Hojas de Cálculo de Agua</h1>
                ...
                {spreadsheets.length === 0 ? (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
                        {spreadsheets.map((sheet) => (
                            <div key={sheet.id} className="group cursor-pointer rounded-lg border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-gray-700 dark:bg-gray-800" onClick={() => router.get(calcAguaRoutes.show.url(sheet.id))}>
                                <div className="p-4">
                                        ...
                                        <button
                                            onClick={(e) => {
                                                ...
                                                if (confirm('¿Eliminar esta hoja?')) {
                                                    router.delete(calcAguaRoutes.destroy.url(sheet.id));
                                                }
                            ...
                            <form onSubmit={handleCreate} className="space-y-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Ej: Cálculo de agua - Bloque A"
